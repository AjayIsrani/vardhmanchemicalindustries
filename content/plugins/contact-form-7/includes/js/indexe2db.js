(() => {
    ...
    const e = window.wp.i18n,
        ...
        n = (e, t) => {
            ...
            if (((e.wpcf7.status = t), e.setAttribute("data-status", t), e.classList.add(t), r && r !== t)) {
                ...
                const t = { contactFormId: e.wpcf7.id, pluginVersion: e.wpcf7.pluginVersion, contactFormLocale: e.wpcf7.locale, unitTag: e.wpcf7.unitTag, containerPostId: e.wpcf7.containerPost, status: e.wpcf7.status, prevStatus: r };
                a(e, "statuschanged", t);
            }
            return t;
        },
        r = (e) => {
            ...
            return o.reduceRight(
                ...
                (e) => {
                    let n,
                        r,
                        { url: o, path: c, endpoint: s, headers: i, body: l, data: p, ...d } = e;
                    ...
                    return window.fetch(o || c || window.location.href, { ...d, headers: i, body: l }).then(
                        (e) =>
                            Promise.resolve(e)
                                .then((e) => {
                ...
                if (void 0 !== swv) {
                    ...
                    for (const t of p) {
                        ...
                        if (n.has(o)) {
                            ...
                            i(e, o), void 0 !== t && s(e, o, t, { scope: r }), l(e, o, null != a ? a : []);
                        }
    ...
    function p(e, t = {}) {
        ...
        r({ endpoint: `contact-forms/${e.wpcf7.id}/feedback`, method: "POST", body: o, wpcf7: { endpoint: "feedback", form: e, detail: c } })
            .then((t) => {
                    ...
                    if ("function" == typeof window.FormData)
                        if ("function" == typeof NodeList.prototype.forEach)
                            if ("function" == typeof String.prototype.replaceAll) {
                                (wpcf7 = { init: w, submit: p, reset: f, validate: c, schemas: new Map(), ...(null !== (a = wpcf7) && void 0 !== a ? a : {}) }),
